...
| 技能 | 路径 | 何时使用 |
|------|------|---------|
| 飞书文档创建 | skills/feishu-create-doc/SKILL.md | 方案需要正式归档到飞书文档时 |
| 飞书文档读取 | skills/feishu-fetch-doc/SKILL.md | 需要读取已有飞书文档作为参考时 |

> 💡 不是每个任务都需要用技能。只在方案需要写入飞书文档时才读取对应 SKILL.md。
